...
\begin{DoxyCode}{0}
\DoxyCodeLine{73 \{}
\DoxyCodeLine{74   \textcolor{keywordtype}{bool} error;}
\DoxyCodeLine{75   \textcolor{keywordflow}{if} (buffer-\/>count != 0U) \textcolor{comment}{/* 버퍼에 데이터가 있으면 */}}
\DoxyCodeLine{76   \{}
\DoxyCodeLine{77     *\mbox{\hyperlink{message_8c_a0523c05685d59544dca911cb6a3db77d}{ch}} = buffer-\/>buff[buffer-\/>out]; \textcolor{comment}{/* 버퍼에서 1Byte 읽음 */}}
\DoxyCodeLine{78     buffer-\/>buff[buffer-\/>out++] = 0;}
\DoxyCodeLine{79     buffer-\/>count-\/-\/;                     \textcolor{comment}{/* 버퍼에 저장된 데이터 갯수 1 감소 */}}
\DoxyCodeLine{80     \textcolor{keywordflow}{if} (buffer-\/>out == \mbox{\hyperlink{message_8h_a0d57378e32bf8278011460740bc29f7f}{UART\_BUFFER\_SIZE}}) \textcolor{comment}{/* 끝 인덱스가 버퍼의 끝이면 */}}
\DoxyCodeLine{81     \{}
\DoxyCodeLine{82       buffer-\/>out = 0; \textcolor{comment}{/* 끝 인덱스를 0부터 다시 시작 */}}
\DoxyCodeLine{83     \}}
\DoxyCodeLine{84     error = \textcolor{keyword}{true};}
\DoxyCodeLine{85   \}}
\DoxyCodeLine{86   \textcolor{keywordflow}{else}}
\DoxyCodeLine{87   \{}
\DoxyCodeLine{88     error = \textcolor{keyword}{false}; \textcolor{comment}{/* 버퍼에 데이터가 없으면 false 리턴 */}}
\DoxyCodeLine{89   \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{40 \{}
\DoxyCodeLine{41     HAL\_UART\_Transmit\_DMA(\&huart3, (uint8\_t *)\&\mbox{\hyperlink{message_8h_aed1d3430d79be36c0a24bc410a75fd78}{uart3Buffer}}.\mbox{\hyperlink{structuart_f_i_f_o___type_def_acbcf5f8de7895ca456bb39fbcccde1d1}{ch}}, 1); \textcolor{comment}{/* UART DMA 인터럽트 시작 */}}
\DoxyCodeLine{42     HAL\_UART\_Transmit\_DMA(\&huart1, (uint8\_t *)\&\mbox{\hyperlink{message_8h_ac8100bb141db19912399a3c1bd92b2ed}{uart1Buffer}}.\mbox{\hyperlink{structuart_f_i_f_o___type_def_acbcf5f8de7895ca456bb39fbcccde1d1}{ch}}, 1);}
\DoxyCodeLine{43 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{52 \{}
\DoxyCodeLine{53   \textcolor{keywordflow}{if} (buffer-\/>count != \mbox{\hyperlink{message_8h_a0d57378e32bf8278011460740bc29f7f}{UART\_BUFFER\_SIZE}}) \textcolor{comment}{/* 데이터가 버퍼에 가득 찼으면 ERROR 리턴 */}}
\DoxyCodeLine{54   \{}
\DoxyCodeLine{55     buffer-\/>buff[buffer-\/>in++] = \mbox{\hyperlink{message_8c_a0523c05685d59544dca911cb6a3db77d}{ch}};    \textcolor{comment}{/* 버퍼에 1Byte 저장 */}}
\DoxyCodeLine{56     buffer-\/>count++;                    \textcolor{comment}{/* 버퍼에 저장된 갯수 1 증가 */}}
\DoxyCodeLine{57     \textcolor{keywordflow}{if} (buffer-\/>in == \mbox{\hyperlink{message_8h_a0d57378e32bf8278011460740bc29f7f}{UART\_BUFFER\_SIZE}}) \textcolor{comment}{/* 시작 인덱스가 버퍼의 끝이면 */}}
\DoxyCodeLine{58     \{}
\DoxyCodeLine{59       buffer-\/>in = 0; \textcolor{comment}{/* 시작 인덱스를 0부터 다시 시작 */}}
\DoxyCodeLine{60     \}}
\DoxyCodeLine{61   \}}
\DoxyCodeLine{62 \}}
